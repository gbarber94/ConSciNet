...
- Data: the simulated coordinate data used in training is provided in the data directory as pickle files. This data can be load using `utlis/data_loader.py`. The code used in data simulation for each system can be found in their respective files: `utils/pendulum_system.py` and `utils/spring_system.py`
