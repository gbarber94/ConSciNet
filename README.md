...
- Data: the simulated coordinate data used in training is provided in the data directory as a pickle file. This data can be load using 'utlis/data_loader.py'.
